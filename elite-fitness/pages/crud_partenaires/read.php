            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["descrip"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Contact Technique</label>
                        <p><b><?php echo $row["ctechnique"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Contact Commercial</label>
                        <p><b><?php echo $row["ccommercial"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Statut</label>
                        <p><b><?php echo $row["statut"]; ?></b></p>
                    </div>
                    <p><a href="../modif_partenaires.php" class="btn btn-primary">Retour</a></p>
                </div>
            </div>        
        </div>
    </div>
